...
모바일 센서(자이로스코프, 가속도계, 방향 센서)를 활용한 실시간 게임 플랫폼입니다. WebSocket을 통해 휴대폰 센서 데이터를 수집하고, **8개의 다양한 장르 게임**에서 활용할 수 있습니다.
