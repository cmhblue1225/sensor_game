...
### 🏎️ 센서 레이싱 게임 (신규)
- **센서 기반 조작**: 휴대폰 기울기로 자동차 조향 및 가속/감속
- **AI 경쟁**: AI 자동차들과 스릴 넘치는 레이싱
- **트랙 시스템**: 랩 타임 측정 및 완주 기능
- **물리 시뮬레이션**: 현실적인 자동차 움직임
...
### 센서 레이싱 게임
- **센서 모드**: 휴대폰을 앞뒤로 기울여 가속/감속, 좌우로 기울여 조향
- **키보드 모드**: WASD 또는 화살표 키
- **센서 보정**: R 키
